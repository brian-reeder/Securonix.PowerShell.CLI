...
Describe 'Get-SecuronixThreatList' {
    BeforeAll {
...
Describe 'Get-SecuronixEntityThreatModel' {
    BeforeAll {
    ...
    Context "When token is valid" {
        ...
        It 'Given required parameters, it returns a list of threats.' {
            $response = Get-SecuronixEntityThreatModel -Url $url -Token $token `
                -DocumentId $documentid -TenantName $tenant
        }
        It 'Given positional parameters, it returns a list of threats.' {
            $response = Get-SecuronixEntityThreatModel $url $token $documentid `
                $tenant
        }
        AfterEach {
            Should -InvokeVerifiable
...
Describe 'Get-SecuronixTopThreatsList' {
    BeforeAll {
...
Describe 'Get-SecuronixTopViolationsList' {
    BeforeAll {
...
Describe 'Get-SecuronixTopViolatorsList' {
    BeforeAll {
