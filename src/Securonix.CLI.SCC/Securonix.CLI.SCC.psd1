#
# Module manifest for module 'Securonix.CLI.SCC'
#
...
RootModule = "$PSScriptRoot\Securonix.CLI.SCC.psm1"

# Version number of this module.
ModuleVersion = '0.0.1'

# ID used to uniquely identify this module
GUID = '35b6cb67-5898-4431-bd2e-79bab80ac1a1'
...
Description = 'A PowerShell module interface to interact with the Security Command Center features in the Securonix SIEM web services.'
...
HelpInfoURI = 'https://github.com/brian-reeder/Securonix.PowerShell.CLI/wiki/Securonix.CLI.SCC'
