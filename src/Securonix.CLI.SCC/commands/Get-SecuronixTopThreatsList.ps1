<#
.DESCRIPTION
Get-SecuronixTopThreatsList prepares API parameters and queries the Securonix API for a list of the Top threats in the Security Command Center.
...
.INPUTS
None. You cannot pipe objects to Get-SecuronixTopThreatsList

.OUTPUTS
System.String. Get-SecuronixTopThreatsList returns the API response. The API will respond with a JSON object for valid requests.

.EXAMPLE
PS> Get-SecuronixTopThreatsList -Url 'DunderMifflin.securonix.com/Snypr' -Token '12345678-90AB-CDEF-1234-567890ABCDEF' -Hours 12

.EXAMPLE
PS> Get-SecuronixTopThreatsList -Url 'DunderMifflin.securonix.com/Snypr' -Token '12345678-90AB-CDEF-1234-567890ABCDEF' -Days 90 -Max 100

.LINK
https://github.com/brian-reeder/Securonix.PowerShell.CLI/blob/main/Docs/Security%20Command%20Center/Get-SecuronixTopThreatsList.md
#>
function Get-SecuronixTopThreatsList {
    [CmdletBinding(
