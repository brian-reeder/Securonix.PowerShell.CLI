#
# Module manifest for module 'Securonix.CLI.List'
#
...
Description = 'A PowerShell module interface to interact with the List features in the Securonix SIEM web services.'
...
HelpInfoURI = 'https://github.com/brian-reeder/Securonix.PowerShell.CLI/wiki/Securonix.CLI.List'
