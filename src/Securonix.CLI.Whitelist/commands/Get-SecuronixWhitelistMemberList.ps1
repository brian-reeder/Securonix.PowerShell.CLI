<#
.DESCRIPTION
Get-SecuronixWhitelistMemberList prepares API parameters and requests Securonix to get the list of members for a Whitelist.
...
.INPUTS
None. You cannot pipe objects to Get-SecuronixWhitelistMemberList.

.OUTPUTS
System.String. Get-SecuronixWhitelistMemberList returns the API response. The API will respond with a JSON object for valid requests.

.EXAMPLE
PS> Get-SecuronixWhitelistMemberList -Url 'DunderMifflin.securonix.com/Snypr' -Token '12345678-90AB-CDEF-1234-567890ABCDEF' -WhitelistName 'remote_users' -TenantName 'PA-Scranton'

.LINK
https://github.com/brian-reeder/Securonix.PowerShell.CLI/blob/main/Docs/Whitelist/Get-SecuronixWhitelist.md
#>
function Get-SecuronixWhitelistMemberList {
    [CmdletBinding(
        PositionalBinding,
